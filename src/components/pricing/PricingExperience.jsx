...
const pricingPlans = [
  {
    ...
    bestFor:
      "Local businesses, clinics, gyms, beauty studios, tuition centres, photographers, and service providers.",
    features: [
  ...
  },
  {
    ...
    bestFor:
      "Growing businesses looking for premium branding, lead-focused websites, and advanced business features.",
    featured: true,
    features: [
  ...
  },
  {
    ...
    bestFor:
      "Companies requiring CRM systems, admin panels, employee portals, analytics dashboards, or custom software.",
    features: [
      "Admin dashboard",
...
const valueCards = [
  {
    ...
    text: "Premium layouts improve trust, clarity, and conversion across every key page.",
  },
  {
    icon: Smartphone,
    title: "Mobile Responsiveness",
    text: "Your site works beautifully for customers browsing from phones and tablets.",
  },
  {
    icon: SearchCheck,
    title: "SEO Optimization",
    text: "Clean structure, metadata, and performance foundations help Google visibility.",
  },
  {
    icon: Zap,
    title: "Fast Performance",
    text: "Optimized pages keep visitors engaged and reduce bounce from slow loading.",
  },
  {
    icon: MessageCircle,
    title: "WhatsApp & Lead Systems",
    text: "Contact flows, WhatsApp CTAs, and lead forms help convert visitors faster.",
  },
  {
    icon: Settings2,
    title: "Business Automation",
    text: "Custom workflows reduce manual work and make operations easier to manage.",
  },
  {
    icon: TestTube2,
    title: "Testing & Quality Assurance",
    text: "Responsive checks and QA reduce broken layouts, errors, and launch risk.",
  },
  {
    icon: Wrench,
    title: "Ongoing Support & Maintenance",
    text: "Regular fixes and improvements keep your website secure and updated.",
  },
];
...
const pricingFaqs = [
  [
    "Why are professional websites expensive?",
    "Professional websites include strategy, UI/UX, responsive design, performance, SEO structure, testing, deployment, and support.",
  ],
  [
    "Why not choose cheap templates?",
    "Cheap templates can be fast to launch, but they often miss branding, scalability, SEO quality, performance tuning, and business-specific workflows.",
  ],
  [
    "What affects website pricing?",
    "Pages, design complexity, animations, forms, dashboards, backend systems, integrations, testing, hosting support, and maintenance all affect pricing.",
  ],
  [
    "Why is maintenance important?",
    "Maintenance keeps your website updated, secure, fast, and aligned with changing business needs.",
  ],
  [
    "Do you provide support after launch?",
    "Yes. RK Web Solutions provides support for fixes, content updates, improvements, and long-term growth.",
  ],
  [
    "Can you build dashboards and admin systems?",
    "Yes. We build dashboards, CRM systems, employee portals, leave systems, booking tools, and custom business workflows.",
  ],
  [
    "Can pricing change based on requirements?",
    "Yes. Final pricing depends on project complexity, custom features, integrations, and timeline.",
  ],
];
...
function PricingCards() {
  return (
    <motion.div
      className="premium-pricing-grid"
          ...
          <div className="pricing-card-actions">
            ...
            <a
              href={getWhatsAppLink(
                `Hi RK Web Solutions, I want to discuss the ${plan.name} package.`,
              )}
...
function PricingNotes() {
  return (
    ...
    >
      <p>
        Pricing may vary based on business requirements, design complexity,
  ...
  return (
    <div className="pricing-subsection startup-friendly-section">
      <div className="pricing-subhead">
        ...
        <p>
          Introductory business pricing gives early clients a professional
          digital foundation without compromising quality.
        </p>
      </div>
      <motion.div
        className="startup-pricing-grid"
        variants={staggerContainer}
        initial="hidden"
        whileInView="visible"
  ...
  return (
    <div className="pricing-subsection">
      <div className="pricing-subhead">
        ...
        <p>
          A website is more than design - it's your digital business identity.
        </p>
      </div>
      <motion.div
...
function PricingEstimator() {
  ...
  const estimate = useMemo(() => {
    const selectedOptions = calculatorOptions.filter((item) =>
      selected.includes(item.id),
    );
    const hasEnterprise = selectedOptions.some(
      (item) => item.tier === "enterprise",
    );
    const hasPremium = selectedOptions.some((item) => item.tier === "premium");
    const premiumCount = selectedOptions.filter(
  ...
  return (
    <div className="pricing-estimator">
      <div>
        ...
        <p>
          Select common website and business features to understand a realistic
          startup-friendly pricing range.
        </p>
        <p className="estimator-small-note">
          Final pricing may vary based on business requirements, design
          complexity, integrations, and custom functionality.
        </p>
      </div>
      <div className="estimator-card">
        ...
        <div className="estimator-options">
          {calculatorOptions.map((option) => (
            <button
              className={
                selected.includes(option.id)
                  ? "estimator-option estimator-option-active"
                  : "estimator-option"
              }
              key={option.id}
              type="button"
            ...
            >
              ...
              <small>
                {selected.includes(option.id) ? "Selected" : "Tap to add"}
              </small>
            </button>
          ))}
        </div>
        <div className="estimate-total">
          ...
          <p>
            Recommended package: <strong>{estimate.packageName}</strong> |
      ...
      <div className="comparison-table">
        ...
        {comparisonRows.map(([label, cheap, rk]) => (
          <div className="comparison-row" key={label}>
            <span>{label}</span>
            <span className={cheap ? "comparison-yes" : "comparison-no"}>
              {cheap ? <CheckCircle2 size={19} /> : <X size={19} />}
            </span>
            <span className={rk ? "comparison-yes" : "comparison-no"}>
              {rk ? <CheckCircle2 size={19} /> : <X size={19} />}
            </span>
          </div>
        ))}
      </div>
  ...
  return (
    <div className="pricing-subsection transformation-section">
      <div className="pricing-subhead">
        ...
        <p>
          See how an outdated business website becomes a premium, lead-focused
          digital experience.
        </p>
      </div>
      ...
      <div className="transformation-showcase">
        <motion.article
          className="transform-card old-transform-card"
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
        ...
        <motion.article
          className="transform-card new-transform-card"
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.25 }}
        >
          ...
          <div className="new-site-preview">
            ...
            <div className="new-site-hero">
              ...
              <p>
                Premium branding, lead-focused sections, fast performance, and
                mobile-first UI.
              </p>
            </div>
    ...
    <div className="pricing-subsection">
      ...
      <div className="pricing-timeline">
        {processSteps.map((step, index) => (
          <motion.div
            className="pricing-timeline-card"
            key={step}
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
    ...
    <div className="pricing-subsection">
      ...
      <div className="pricing-faq-list">
        {pricingFaqs.map(([question, answer], index) => (
          <div
            className={`pricing-faq-item ${open === index ? "pricing-faq-open" : ""}`}
            key={question}
          >
            <button
              type="button"
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p>
          Understand what goes into building a modern business website and why
          quality matters.
        </p>
      </div>
      <a
        className="btn btn-primary"
        href="/rk-web-solutions-pricing-guide.pdf"
        target="_blank"
        rel="noreferrer"
      >
...
function PricingFinalCta() {
  return (
    <div className="pricing-final-cta">
      ...
      <p>
        Let's create a modern website or dashboard solution that helps your
        business grow.
      </p>
      <div>
        <a
        ...
        <a
          className="btn btn-ghost"
          href={getWhatsAppLink(
            "Hi RK Web Solutions, I want to discuss a website or dashboard project.",
          )}
          target="_blank"
          rel="noreferrer"
        >
  ...
  return (
    <section id="pricing" className="pricing-experience section-shell">
      <div className="pricing-hero-head">
        ...
        <p>
          Affordable for early clients, but still built with strategy, UI/UX,
          responsive development, SEO foundations, testing, performance, and
          deployment support.
        </p>
      </div>
      <PricingCards />
